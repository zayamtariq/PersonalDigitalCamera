 ...
 * @details   TM4C123 is master. I2C2 is connected to PE4=SCL, PE5=SDA<br>
 ...
 * @date      Jan 2, 2021
<table>
<caption id="I2C2ports">I2C connected to I2C2</caption>
<tr><th>Pin   <th>signal
<tr><td>GND   <td>ground
<tr><td>VIN   <td>3.3V
<tr><td>PE5   <td>I2C SDA data (bidirectional)
<tr><td>PE4   <td>I2C SCL clock (TM4C123 output)
</table>
 ******************************************************************************/
 ...
 * ----------
 * @brief write 1 or more bytes to I2C2.
 */
 ...
 * ----------
 * @brief read 1 or more bytes from I2C2.
 */
 ...
 * @param  count      number of bytes to be read.
 * @brief read 2 or more bytes from I2C2.
 */
 ...
 * @param  count      number of bytes to be writen.
 * ----------
 * @brief write many bytes to I2C2.
 */
