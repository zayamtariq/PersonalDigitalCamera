...
//*****************************************************************************
static long
CANIntNumberGet(uint32_t ulBase)
{
    long lIntNumber;
...
//*****************************************************************************
static uint32_t
CANRegRead(uint32_t ulRegAddress)
{
    volatile int iDelay;
    uint32_t ulRetVal;
...
//*****************************************************************************
static void
CANRegWrite(uint32_t ulRegAddress, uint32_t ulRegValue)
{
    volatile int iDelay;
...
//*****************************************************************************
static void
CANDataRegWrite(unsigned char *pucData, uint32_t *pulRegister, int iSize)
{
    int iIdx;
    uint32_t ulValue;
...
//*****************************************************************************
static void
CANDataRegRead(unsigned char *pucData, uint32_t *pulRegister, int iSize)
{
    int iIdx;
    uint32_t ulValue;
...
//*****************************************************************************
uint32_t
CANBitRateSet(uint32_t ulBase, uint32_t ulSourceClock,
              uint32_t ulBitRate)
{
...
//*****************************************************************************
uint32_t
CANIntStatus(uint32_t ulBase, tCANIntStsReg eIntStsReg)
{
    uint32_t ulStatus;
...
//*****************************************************************************
uint32_t
CANStatusGet(uint32_t ulBase, tCANStsReg eStatusReg)
{
    uint32_t ulStatus;
...
//*****************************************************************************
tBoolean
CANErrCntrGet(uint32_t ulBase, uint32_t *pulRxCount,
              uint32_t *pulTxCount)
{
    uint32_t ulCANError;
