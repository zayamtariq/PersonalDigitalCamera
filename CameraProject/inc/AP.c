...
#ifdef APDEBUG
#define OutString(STRING) UART_OutString(STRING)
#define OutUHex(NUM) UART_OutUHex(NUM)
#define OutUHex2(NUM) UART_OutUHex2(NUM)
#define OutChar(N) UART_OutChar(N)
#else
